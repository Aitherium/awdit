...
interesting failures live BETWEEN them. "awdit is installed" is not the useful
fact -- "awdit is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awdit'
FAMILY = ['awask', 'awask', 'awbac', 'awbrowse', 'awevolve', 'awevolve', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awnode', 'awpredict', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['awbac', 'awseal']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awdit needs at runtime, and a
